...
pubDate: ''
thumbnail: '/assets/images/gamedev/timeless/7-relative-vertex-movement-static/RelativeVertexMovement_EndResult_Thumbnail.png'
endResultGif: '/assets/images/gamedev/timeless/7-relative-vertex-movement-static/RelativeVertexMovement_EndResult.gif'
author: 'Battery'
...
![RelativeVertexMovementEndResultGif](/assets/images/gamedev/timeless/7-relative-vertex-movement-static/RelativeVertexMovement_EndResult.gif)
...
![StartingOff](/assets/images/gamedev/timeless/7-relative-vertex-movement-static/StartingOff.png)

## First Implementation

After experimenting for awhile with Unreal's built in functions for finding overlapping components.

![UnrealBuiltInIsOverlapFunctions](/assets/images/gamedev/timeless/7-relative-vertex-movement-static/UnrealIsOverlapping.png)
...
![IncompatibleReferenceTypes](/assets/images/gamedev/timeless/7-relative-vertex-movement-static/ActorComponentObjectReferenceIncompatible.png)
...
![NestedForLoopImplementation](/assets/images/gamedev/timeless/7-relative-vertex-movement-static/NestedForLoopImplementation.png)
...
![CollisionEventSetup](/assets/images/gamedev/timeless/7-relative-vertex-movement-static/CollisionEventSetup.png)
...
![DebugPrintCurrentVertex](/assets/images/gamedev/timeless/7-relative-vertex-movement-static/DebugPrintCurrentVertex.png)
...
![GetRelativeVertexSelectionViaModulo](/assets/images/gamedev/timeless/7-relative-vertex-movement-static/GetRelativeVertexSelectionViaModulo.png)
...
![TotalGetRelativeVertexGraph](/assets/images/gamedev/timeless/7-relative-vertex-movement-static/TotalGetRelativeVertexGraph.png)
...
![RelativeMovementAndAbsoluteMovement](/assets/images/gamedev/timeless/7-relative-vertex-movement-static/RelativeMovementAndAbsoluteMovement.png)
