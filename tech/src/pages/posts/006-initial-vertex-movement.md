...
pubDate: ''
thumbnail: '/assets/images/gamedev/timeless/6-initial-vertex-movement-static/InitialVertexBasedMovement_EndResult_Thumbnail.png'
endResultGif: '/assets/images/gamedev/timeless/6-initial-vertex-movement-static/InitialVertexBasedMovement_EndResult.gif'
author: 'Battery'
...
![InitialVertexBasedMovementEndResultGif](/assets/images/gamedev/timeless/6-initial-vertex-movement-static/InitialVertexBasedMovement_EndResult.gif)
...
![AddSphereColliders](/assets/images/gamedev/timeless/6-initial-vertex-movement-static/AddSphereColliders.png)
...
![ThreeHexesShareAVertex](/assets/images/gamedev/timeless/6-initial-vertex-movement-static/ThreeHexesShareVertex.png)
...
![TopViewSphereColliders](/assets/images/gamedev/timeless/6-initial-vertex-movement-static/TopViewSphereColliders.png)

And here's the front view.

![FrontViewSphereColliders](/assets/images/gamedev/timeless/6-initial-vertex-movement-static/FrontViewSphereColliders.png)
...
![IndividualHotkey](/assets/images/gamedev/timeless/6-initial-vertex-movement-static/IndividualHotkey.png)
...
![HotkeysTogether](/assets/images/gamedev/timeless/6-initial-vertex-movement-static/HotkeysTogether.png)
...
![GetVertexComponentTransforms](/assets/images/gamedev/timeless/6-initial-vertex-movement-static/GetVertexComponentTransforms.png)
...
![SetSelectedVertexWorldLocationVariable](/assets/images/gamedev/timeless/6-initial-vertex-movement-static/SetSelectedVertexWorldLocationVariable.png)
...
![SetActorLocationNode](/assets/images/gamedev/timeless/6-initial-vertex-movement-static/SetActorLocationNode.png)
...
![WoWMonkRolls](/assets/images/gamedev/timeless/6-initial-vertex-movement-static/WoWMonkRolls.gif)
...
![CharacterLocationToLerp](/assets/images/gamedev/timeless/6-initial-vertex-movement-static/CharacterLocationToLerp.png)

For the end point we could pass in the `SelectedVertexWorldLocation` directly like this.

![SetEndPointDirectly](/assets/images/gamedev/timeless/6-initial-vertex-movement-static/SetEndPointDirectly.png)
...
![LerpStartAndEnd](/assets/images/gamedev/timeless/6-initial-vertex-movement-static/LerpStartAndEnd.png)
...
![Timeline](/assets/images/gamedev/timeless/6-initial-vertex-movement-static/Timeline.png)
...
![FinishedLerpFunctionality](/assets/images/gamedev/timeless/6-initial-vertex-movement-static/FinishedLerpFunctionality.png)
