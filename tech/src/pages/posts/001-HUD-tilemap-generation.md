...
pubDate: '01/07/2024'
thumbnail: '/assets/images/gamedev/timeless/1-editor-hud-tilemap-generation-static/HUDTilemapGeneration_EndResult_Thumbnail.png'
endResultGif: '/assets/images/gamedev/timeless/1-editor-hud-tilemap-generation-static/HUDTilemapGeneration_EndResult.gif'
author: 'Battery'
...
![EndResultDemoGif](/assets/images/gamedev/timeless/1-editor-hud-tilemap-generation-static/HUDTilemapGeneration_EndResult.gif)
...
![HUDElement](/assets/images/gamedev/timeless/1-editor-hud-tilemap-generation-static/HUD-1.png)
...
![GetLevelEditorHUDRef_Function](/assets/images/gamedev/timeless/1-editor-hud-tilemap-generation-static/GetLevelEditorHUDRefFunction.png)


Here's an example showing how this function can be used to easily access variables and elements from the UI.

![GetLevelEditorHUDRef_usage_example](/assets/images/gamedev/timeless/1-editor-hud-tilemap-generation-static/GetLevelEditorHUDRef_usage_example.png)
...
![CanvasElements](/assets/images/gamedev/timeless/1-editor-hud-tilemap-generation-static/CanvasElements.png)
...
![ActiveDisplayShapeVariable](/assets/images/gamedev/timeless/1-editor-hud-tilemap-generation-static/ActiveDisplayShapeVariable.png)
...
![SwitchOnString](/assets/images/gamedev/timeless/1-editor-hud-tilemap-generation-static/SwitchOnStringNode.png)
...
![SpawnTiles](/assets/images/gamedev/timeless/1-editor-hud-tilemap-generation-static/spawntiles.png)
...
![ChatGPTColorPalettes](/assets/images/gamedev/timeless/1-editor-hud-tilemap-generation-static/ChatGPTColorPalettes.png)
...
![ColorPalettesBP](/assets/images/gamedev/timeless/1-editor-hud-tilemap-generation-static/ColorPalettesBP.png)
